...
| canonical-implementation | `packages/ui/src/components/ui/input.tsx` | 123 |
...
| molecular-candidate | not-reviewed | `AgentCard` in `packages/ui/src/cloud-ui/components/brand/brand-card.tsx:58` | - | `BrandCard`, `div`, `h3`, `p` |
...
| molecular-candidate | not-reviewed | `MessagePermissionCard` in `packages/ui/src/components/chat/MessageContent.tsx:1255` | - |  |
...
| canonical-wrapper | not-reviewed | `CloudConfirmDialog` in `packages/ui/src/components/settings/cloud-panel/cloud-settings-primitives.tsx:681` | - | `Button`, `CloudModal`, `div`, `p` |
...
| canonical-wrapper | consolidation-candidate | `CloudTextInput` in `packages/ui/src/components/settings/cloud-panel/cloud-settings-primitives.tsx:749` | `packages/ui/src/components/ui/input.tsx` | `Input` |
